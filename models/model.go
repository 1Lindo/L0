...
type EventOrder struct {
	...
	DateCreated       string   `json:"date_created" db:"date_created"` // TODO to time.Time
	OofShard          string   `json:"oof_shard" db:"oof_shard"`
	CreatedAt         string   `json:"created_at" db:"created_at"` // TODO to time.Time
}
